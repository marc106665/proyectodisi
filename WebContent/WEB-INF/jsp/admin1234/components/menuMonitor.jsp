        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container-fluid">
            ...
            <header class="navbar-header">
              ...
              <a href="${pageContext.request.contextPath}/admin1234/${idMonitor}.html" class="navbar-brand">
            ...
            <div class="topnav">
              ...
              <div class="btn-group">
                <a data-toggle="modal" data-original-title="Mi cuenta" data-placement="bottom" class="btn btn-default btn-sm" href="miCuenta/${user.usuario}.html">
                  <i class="fa fa-cog"></i>
                </a> 
