              ...
              <div class="col-lg-12">
                <div class="box dark">
                  ...
                  <div id="div-1" class="body">
                    ...
                    <form:form enctype="multipart/form-data" modelAttribute="actividad" class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/admin1234/addActividad.html">
		            ...
		            <input type="number" value="0" style="display:none;" id="precio3" name="precio3" class="form-control">
					  ...
					  <div class="form-group">
	                        ...
	                        <div class="col-lg-1 col-sm-2">
	                        	<form:input path="minParticipantes" min="1" tabindex="12" type="number" id="minParticipantes" placeholder="4..." class="form-control"/>
	                        </div>
		                    ...
		                    <div class="col-lg-1 col-sm-2">
		                    	<form:input path="maxParticipantes" min="1" tabindex="13" type="number" id="maxParticipantes" placeholder="20..." class="form-control"/>
